...
export const _dummySessions: Session[] = [
  ...
  { id: 2, opened_by: 1, opened_at: new Date('2021-03-02'), closed_at: new Date('2021-04-02'), status: SessionStatus.Closed },
  { id: 3, opened_by: 1, opened_at: new Date('2021-05-03'), closed_at: new Date('2021-06-03'), status: SessionStatus.Closed },
  { id: 4, opened_by: 1, opened_at: new Date('2021-07-04'), closed_at: new Date('2021-08-04'), status: SessionStatus.Closed },
  { id: 5, opened_by: 1, opened_at: new Date('2021-09-05'), closed_at: new Date('2021-10-05'), status: SessionStatus.Closed },
  { id: 6, opened_by: 1, opened_at: new Date('2021-11-06'), closed_at: new Date('2021-12-06'), status: SessionStatus.Closed },
  { id: 7, opened_by: 1, opened_at: new Date('2021-01-13'), closed_at: new Date('2021-01-14'), status: SessionStatus.Closed },
...
export const dummyEmployees: Employee[] = [
  { id: 1, number: '12345678', name: 'Amine Ayari', gender: Gender.Male, job_position: 'Waiter', phone: '96951706', contract_type: ContractType.Cdd, cnss_registration_number: '12345678' },
  { id: 2, number: '12345679', name: 'Firas Gharbi', gender: Gender.Female, job_position: 'Bartender', phone: '56027707', contract_type: ContractType.Cdd, cnss_registration_number: '12345678' },
  { id: 3, number: '12345680', name: 'Amine Masmoudi', gender: Gender.Male, job_position: 'Chef', phone: '59427708', contract_type: ContractType.Cdd, cnss_registration_number: '12345678' },
  { id: 4, number: '12345681', name: 'Amine Masmoudi', gender: Gender.Male, job_position: 'Bartender', phone: '99649691', contract_type: ContractType.Cdd, cnss_registration_number: '12345678' },
  { id: 5, number: '12345682', name: 'Sarra Masmoudi', gender: Gender.Female, job_position: 'Host', phone: '42847339', contract_type: ContractType.Cdd, cnss_registration_number: '12345678' },
  { id: 6, number: '12345670', name: 'John Doe', gender: Gender.Male, job_position: 'Cook', phone: '12345679', contract_type: ContractType.Cdi, cnss_registration_number: '98765432' },
  { id: 7, number: '12345671', name: 'Jane Doe', gender: Gender.Female, job_position: 'Cashier', phone: '98765433', contract_type: ContractType.Cdi, cnss_registration_number: '98765432' },
  { id: 8, number: '12345672', name: 'Ali Ben Romdhane', gender: Gender.Male, job_position: 'Manager', phone: '98765434', contract_type: ContractType.Cdi, cnss_registration_number: '98765432' },
  { id: 9, number: '12345673', name: 'Fatima Bentayeb', gender: Gender.Female, job_position: 'Server', phone: '98765435', contract_type: ContractType.Cdi, cnss_registration_number: '98765432' },
  { id: 10, number: '12345674', name: 'Khaled Ben Ali', gender: Gender.Male, job_position: 'Busser', phone: '98765436', contract_type: ContractType.Cdi, cnss_registration_number: '98765432' }
];
...
export const dummyCategories: Category[] = [
  ...
  { id: 5, name: 'Seafood', description: 'Fresh from the sea to your plate.', icon: 'sailing' },
...
const _dummyProducts: Product[] = [
  { id: 1, name: "Margherita Pizza", description: "Classic pizza with tomato sauce and mozzarella cheese", category_id: 1, price: 12.99, quantity: 10, image_path: "path/to/margherita.jpg" },
  { id: 2, name: "Caesar Salad", description: "Fresh romaine lettuce with Caesar dressing, croutons, and parmesan cheese", category_id: 1, price: 8.50, quantity: 15, image_path: "path/to/caesar_salad.jpg" },
  { id: 3, name: "Spaghetti Carbonara", description: "Traditional Italian pasta with creamy sauce, pancetta, and egg", category_id: 1, price: 14.00, quantity: 8, image_path: "path/to/carbonara.jpg" },
  { id: 4, name: "Grilled Salmon", description: "Grilled salmon fillet with a side of vegetables", category_id: 1, price: 18.75, quantity: 5, image_path: "path/to/grilled_salmon.jpg" },
  { id: 5, name: "Chocolate Cake", description: "Rich and moist chocolate cake with chocolate frosting", category_id: 1, price: 6.50, quantity: 20, image_path: "path/to/chocolate_cake.jpg" },
  { id: 6, name: "Mojito", description: "Refreshing cocktail with rum, mint, lime, sugar, and soda water", category_id: 1, price: 7.00, quantity: 30, image_path: "path/to/mojito.jpg" },
  { id: 7, name: "Beef Burger", description: "Juicy beef patty with lettuce, tomato, and cheese on a brioche bun", category_id: 1, price: 10.00, quantity: 12, image_path: "path/to/beef_burger.jpg" },
  { id: 8, name: "Tiramisu", description: "Italian coffee-flavored dessert with mascarpone cheese", category_id: 1, price: 7.00, quantity: 10, image_path: "path/to/tiramisu.jpg" },
  { id: 9, name: "Tomato Soup", description: "Creamy tomato soup served with croutons and fresh basil", category_id: 1, price: 5.99, quantity: 15, image_path: "path/to/tomato_soup.jpg" },
  { id: 10, name: "Mushroom Risotto", description: "Creamy risotto with wild mushrooms and parmesan cheese", category_id: 1, price: 13.50, quantity: 7, image_path: "path/to/mushroom_risotto.jpg" },
  { id: 11, name: "Apple Pie", description: "Traditional apple pie with a flaky crust, served with vanilla ice cream", category_id: 1, price: 6.75, quantity: 10, image_path: "path/to/apple_pie.jpg" },
  { id: 12, name: "Lemonade", description: "Freshly squeezed lemonade with a touch of sweetness", category_id: 1, price: 3.50, quantity: 25, image_path: "path/to/lemonade.jpg" },
  { id: 13, name: "Caprese Salad", description: "Fresh mozzarella, tomatoes, basil, and balsamic glaze", category_id: 1, price: 9.00, quantity: 10, image_path: "path/to/caprese_salad.jpg" },
  { id: 14, name: "Grilled Cheese Sandwich", description: "Melted cheese between slices of toasted bread", category_id: 1, price: 4.99, quantity: 20, image_path: "path/to/grilled_cheese.jpg" },
  { id: 15, name: "Espresso", description: "Strong and richly flavored concentrated coffee", category_id: 1, price: 2.50, quantity: 40, image_path: "path/to/espresso.jpg" }
];
...
export const dummyCustomers: Customer[] = [
  {id: 1, name: "Amal Ben Ali", email: "amal.benali@example.tn", phone: "+216 55 555 555"},
  {id: 2, name: "Mohamed Bouazizi", email: "mohamed.bouazizi@example.tn", phone: "+216 71 111 111"},
  {id: 3, name: "Leila Trabelsi", email: "leila.trabelsi@example.tn", phone: "+216 22 222 222"},
  {id: 4, name: "Sami Khelifa", email: "sami.khelifa@example.tn", phone: "+216 99 999 999"},
  {id: 5, name: "Yasmine Bechir", email: "yasmine.bechir@example.tn", phone: "+216 44 444 444"},
  {id: 6, name: "Karim Mejri", email: "karim.mejri@example.tn", phone: "+216 33 333 333"},
  {id: 7, name: "Sonia Jabri", email: "sonia.jabri@example.tn", phone: "+216 66 666 666"},
  {id: 8, name: "Ahmed Laabidi", email: "ahmed.laabidi@example.tn", phone: "+216 88 888 888"},
  {id: 9, name: "Hanan Gharbi", email: "hanan.gharbi@example.tn", phone: "+216 11 111 111"},
  {id: 10, name: "Ali Mestiri", email: "ali.mestiri@example.tn", phone: "+216 77 777 777"},
  {id: 11, name: "Nour Hamdi", email: "nour.hamdi@example.tn", phone: "+216 22 222 222"},
  {id: 12, name: "Marwan Boughedir", email: "marwan.boughedir@example.tn", phone: "+216 99 999 999"},
  {id: 13, name: "Lina Ben Achour", email: "lina.benachour@example.tn", phone: "+216 44 444 444"},
  {id: 14, name: "Zied Dridi", email: "zied.dridi@example.tn", phone: "+216 33 333 333"},
  {id: 15, name: "Imen Chakroun", email: "imen.chakroun@example.tn", phone: "+216 66 666 666"},
];
...
const dummyBuyXGetY: BuyXGetY[] = [
  { code: '17cf-de7b-baca', buy: 1, get: 2, status: BuyXGetYStatus.Active, program_id : 2 },
  { code: '5f3a-8d9e-4ab7', buy: 1, get: 2, status: BuyXGetYStatus.Active, program_id : 2 },
